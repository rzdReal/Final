...
var proxiedFunctionTable = [ null, _atexit, _emscripten_set_canvas_element_size_main_thread, _environ_get, _environ_sizes_get, _fd_write ];
...
var _emscripten_bind_articleAnalyzer_articleAnalyzer_1 = Module["_emscripten_bind_articleAnalyzer_articleAnalyzer_1"] = createExportWrapper("emscripten_bind_articleAnalyzer_articleAnalyzer_1");

var _emscripten_bind_articleAnalyzer_process_1 = Module["_emscripten_bind_articleAnalyzer_process_1"] = createExportWrapper("emscripten_bind_articleAnalyzer_process_1");

var _emscripten_bind_articleAnalyzer___destroy___0 = Module["_emscripten_bind_articleAnalyzer___destroy___0"] = createExportWrapper("emscripten_bind_articleAnalyzer___destroy___0");
...
var __emscripten_allow_main_runtime_queued_calls = Module["__emscripten_allow_main_runtime_queued_calls"] = 15280;

var __emscripten_main_thread_futex = Module["__emscripten_main_thread_futex"] = 15908;
...
function articleAnalyzer(threadNum) {
 if (threadNum && typeof threadNum === "object") threadNum = threadNum.ptr;
 this.ptr = _emscripten_bind_articleAnalyzer_articleAnalyzer_1(threadNum);
 getCache(articleAnalyzer)[this.ptr] = this;
}

articleAnalyzer.prototype = Object.create(WrapperObject.prototype);

articleAnalyzer.prototype.constructor = articleAnalyzer;

articleAnalyzer.prototype.__class__ = articleAnalyzer;

articleAnalyzer.__cache__ = {};

Module["articleAnalyzer"] = articleAnalyzer;

articleAnalyzer.prototype["process"] = articleAnalyzer.prototype.process = function(input) {
 var self = this.ptr;
 ensureCache.prepare();
 if (input && typeof input === "object") input = input.ptr; else input = ensureString(input);
 return UTF8ToString(_emscripten_bind_articleAnalyzer_process_1(self, input));
};

articleAnalyzer.prototype["__destroy__"] = articleAnalyzer.prototype.__destroy__ = function() {
 var self = this.ptr;
 _emscripten_bind_articleAnalyzer___destroy___0(self);
};
